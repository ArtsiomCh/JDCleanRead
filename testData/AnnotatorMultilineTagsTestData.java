 ...
 *
 * multiline html tag with nested javadoc tag: <info descr="null"><pre></info><info descr="null"> html tag body </info><info descr="null"><info descr="null">{@code</info></info>
 * <info descr="null"><info descr="null">  html and javadoc tag body</info></info>
 * <info descr="null"><info descr="null">}</info></info><info descr="null"> html tag body </info><info descr="null"></pre></info>
 *
...
public class AnnotatorMultilineTagsTestData {
